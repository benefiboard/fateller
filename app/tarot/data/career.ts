...
export const CAREER_TAROT_CARDS: SingleTarotCard[] = [
  {
    id: 'fool',
    name: {
      ko: '광대',
...
// 카드 ID로 카드 정보 찾기
export const getCareerCardById = (id: string): SingleTarotCard | undefined => {
  return CAREER_TAROT_CARDS.find((card) => card.id === id);
};

// 랜덤 해석 선택
export const getRandomCareerInterpretation = (card: SingleTarotCard) => {
