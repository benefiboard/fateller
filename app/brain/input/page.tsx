...
4. 카테고리 분류 원칙:
  - 메모의 표면적 주제보다 작성 목적과 활용 의도를 우선 고려하세요.
  - 문서의 형식과 구조적 특징(목차, 서술 방식, 문체 등)이 분류에 중요한 단서가 됩니다.
  - 동일한 주제라도 다른 목적으로 작성된 메모는 다른 카테고리에 속할 수 있습니다.
  - 어떤 환경이나 상황에서 이 메모가 활용될지 고려하여 분류하세요.
  - 메모가 여러 특성을 가진 경우, 가장 주된 의도와 활용 목적에 맞는 카테고리를 선택하세요.
