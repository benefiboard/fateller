      ...
      const requestBody = {
        ...
        messages: [
          ...
          3. 복합 생각인 경우 중심 아이디어 추출 및 자식 카드 생성
             ...
             - 내용을 너무 잘게 나누지 말고, 중요한 상위 개념 단위로 구분할 것
             - 하나의 중심 아이디어는 의미있는 단위의 내용을 포함해야 함
             - 지나치게 세부적인 내용보다는 메모의 주요 섹션이나 주제를 기준으로 나눌 것
             - 각 중심 아이디어가 다른 생각들과 연결 가능성이 있는지 판단
             - 중심 아이디어는 표면적 서술이 아닌 근본적인 개념이나 통찰 포함
             - 각 중심 아이디어마다 별도의 자식 카드 생성 (제목, 내용, 키워드 포함)
          
          4. 카테고리 분류 원칙:
            - 메모의 표면적 주제보다 작성 목적과 활용 의도를 우선 고려해.
            - 문서의 형식과 구조적 특징(목차, 서술 방식, 문체 등)이 분류에 중요한 단서가 돼.
            - 동일한 주제라도 다른 목적으로 작성된 메모는 다른 카테고리에 속할 수 있어.
            - 어떤 환경이나 상황에서 이 메모가 활용될지 고려해 분류해.
            - 메모가 여러 특성을 가진 경우, 가장 주된 의도와 활용 목적에 맞는 카테고리를 선택해.
